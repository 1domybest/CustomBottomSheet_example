...
open class IOStream: NSObject {
    ...
    public func registerGpuPixelDelegate(_ delegate: IOVideoMixerGpuPixelDelegate?) {
        self.mixer.videoIO.registerGpuPixelDelegate(delegate)
    }
    
    public func processVideo(_ sampleBuffer: CMSampleBuffer) {
        // outputSampleBuffer(_ sampleBuffer: CMSampleBuffer)
        self.mixer.videoIO.processVideo(sampleBuffer)
    }
    
    public func stopVideoRunning() {
        self.mixer.videoIO.setBackgroundMode(true)
    }
    
    public func startVideoRunning() {
        self.mixer.videoIO.setBackgroundMode(false)
    }
